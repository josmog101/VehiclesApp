...
class ApiHelper {
  ...
  static Future<Response> getBrands(String token) async {
    var url = Uri.parse(
        '${Constans.apiUrl}?function=Brands&access_key=${Constans.accessKey}');
    var response = await http.get(
      url,
      headers: {
        'content-type': 'application/json',
  ...
  static Future<Response> getDocumentTypes(String token) async {
    var url = Uri.parse(
        '${Constans.apiUrl}?function=DocumentTypes&access_key=${Constans.accessKey}');
    var response = await http.get(
      url,
      headers: {
        'content-type': 'application/json',
  ...
  static Future<Response> getVehicleTypes(String token) async {
    var url = Uri.parse(
        '${Constans.apiUrl}?function=VehicleTypes&access_key=${Constans.accessKey}');
    var response = await http.get(
      url,
      headers: {
        'content-type': 'application/json',
  ...
  static Future<Response> post(
    ...
    var url = Uri.parse(
        '${Constans.apiUrl}?function=${controller}&access_key=${Constans.accessKey}');
