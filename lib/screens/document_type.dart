...
class _DocumentTypeScreenState extends State<DocumentTypeScreen> {
        ...
        children: [
          Row(
            ...
            children: <Widget>[
              ...
              widget.documentType.id == 0 ? Container() : _showBorrarButton(),
            ],
          ),
        ],
      ),
  ...
  _addRecord() async {
    ...
    Response response =
        await ApiHelper.post('DocumentTypeAdd', request, widget.token.token);
  ...
  _saveRecord() async {
    ...
    Response response = await ApiHelper.put('DocumentTypePut',
  ...
  void _deleteRecord() async {
    ...
    Map<String, dynamic> request = {'id': widget.documentType.id};
    Response response = await ApiHelper.delete('DocumentTypeDelete',
        widget.documentType.id.toString(), request, widget.token.token);
